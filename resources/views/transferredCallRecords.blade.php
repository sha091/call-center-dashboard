                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-md-6">
                                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                    ...
                                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Transferred Calls Report</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('transferred.call.report') }}" method="GET">
                                                @csrf
                                                ...
                                                <div class="modal-footer">
                                                    <a href="javascript:void(0);" type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="window.location='{{ route('transferred.call.report') }}'">Clear</a>
                            ...
                            <tbody>
                                @forelse ($cdrs as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{ date('d-m-Y', strtotime($value->call_date)) }}</td>
...
<script>
    $(document).ready(function() {
        $('#exportBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('export.transferred.call.report') }}", // The route to your export controller
                type: 'GET',
                data:{
                    "startDate":startDate,
                    "endDate":endDate,
