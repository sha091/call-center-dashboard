                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-md-6">
                                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                    ...
                                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Call Records</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-header p-3 pt-2">
                        <div class="row my-1">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <button id = 'exportBtn' type="button" class="btn btn-outline-success float-end mx-3">Export Excel</button>
                                <!-- Modal -->
                                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('call.records') }}" method="GET">
                                                @csrf
                                                        ...
                                                        <div class="col-md-6 col-lg-6 col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select"  name="search_keyword">
                                                                    ...
                                                                    <option   value="OFFTIME" >Off Time Calls</option>
                                                                    <option   value="SHIFT" style="display:none"  >Shift Calls</option>
                                                                    <option   value="ANSWERED" >Answered Calls (I+O)</option>
                                                                    <option   value="DROP" style="display:none" >Drop Calls</option>
                                                                    <option   value="INBOUND" >Inbound Answered Calls</option>
                                                                    <option   value="OUTBOUND" >Attempt Outbound Calls</option>
                                                                    <option   value="DIALED" >Unsuccessfull Outbound Calls</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    <a href="javascript:void(0);" type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="window.location='{{ route('call.records') }}'">Clear</a>
                            ...
                            <tbody>
                                @forelse ($cdrs as $value)
                                    <tr>
                                        ...
                                        <td>{{ date('h:i:s A', strtotime($value->call_time)) }}</td>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <audio controls style="height: 35px;min-width: 250px;vertical-align: middle;">
                                                <source src="{{ $value->userfield }}" type="audio/wav">
                                                Your browser does not support the audio element.
                                            </audio>
                                            {{-- <div class="essential_audio circle" data-url="http://10.100.50.229/09001-20250109161757.wav" ></div> --}}
                                        </td>
                                    </tr>
                                    @empty
                                        <tr>
...
$(document).ready(function() {
    $('#exportBtn').on('click', function() {
        ...
        let search_keyword = "{{ isset($_GET['search_keyword']) ? $_GET['search_keyword'] : false }}";
        let keywords    =  "{{ isset($_GET['keywords']) ? $_GET['keywords'] : false }}";
        // Send AJAX request to trigger export
        $.ajax({
            url: "{{ route('export.call.records') }}", // The route to your export controller
            type: 'GET',
            data:{
                "startDate":startDate,
                "endDate":endDate,
